...
const __export = {
  name: 'default',
  label: (__defineLayout as any).label || 'Default',
  allowedBlocks: (__defineLayout as any).allowedBlocks,
  allowedRootBlocks: (__defineLayout as any).allowedRootBlocks,
}
export default __export as unknown as LayoutDefinition
